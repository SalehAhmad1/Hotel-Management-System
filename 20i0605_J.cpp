//Saleh Ahmad 20I-0605 SP21 OOP Project
#include<iostream>
#include<string>
#include<fstream>
using namespace std;
class Room //Parent Class 
{
    ...
    bool reservation_availability; //Availabile to reserve check
...
class Date //Class of Date
{
    ...
    void operator++(int i) //Increment operator overloader
    {
    ...
    void operator-(int i)  //Subtraction operator overloader
    {
        date -= i;
    }
